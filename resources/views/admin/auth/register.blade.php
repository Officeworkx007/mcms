...
<head>
    ...
    <title>Admin Registration — HCLSC Samadhan</title>
    <meta name="robots" content="noindex, nofollow">
    <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="bg-slate-50 min-h-screen flex items-center justify-center px-6 py-12">

    <div class="w-full max-w-sm">
        <h1 class="text-xl font-bold text-slate-800 text-center">Create Admin Account</h1>
        ...
        <form method="POST" action="{{ route('admin.register') }}"
            ...
            <div class="mb-4">
                <label for="name"
                    class="block text-xs font-semibold text-slate-600 uppercase tracking-wide mb-1.5">Full name</label>
            ...
            <div class="mb-6">
                <label for="password_confirmation"
                    class="block text-xs font-semibold text-slate-600 uppercase tracking-wide mb-1.5">Confirm
                    password</label>
        ...
        <p class="text-center text-xs text-slate-400 mt-6">
            Already have an account? <a href="{{ route('admin.login') }}"
                class="text-slate-700 font-medium hover:underline">Sign in</a>
        </p>
    </div>
