...
@section('content')
    ...
    <div class="u-page-head">
        <div class="u-page-head-left">
            ...
            <div>
                <h1>Edit Category</h1>
                <p class="u-page-subtitle">{{ $category->name }}</p>
            </div>
        </div>
    ...
    <form method="POST" action="{{ route('user.categories.update', $category) }}" class="u-form-card">
        @csrf
        @method('PUT')
        ...
        <div class="u-form-actions">
            <button type="submit" class="u-btn-primary">Update Category</button>
