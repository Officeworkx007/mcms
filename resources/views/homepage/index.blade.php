...
<body>
    ...
    <section class="hero">
        <div class="hero-copy">
            ...
            <p>HCLSC's mediation case management system keeps referrals, sittings, and outcomes organised — from the day
                a case is referred to the day it's settled.</p>
        ...
        <div class="hero-art" aria-hidden="true">
            ...
            <svg class="art-svg" viewBox="0 0 440 400" fill="none">
                ...
                <circle class="resolve-dot" cx="220" cy="200" r="16" stroke="#22D3B2" stroke-width="1.5"
                    opacity="0.35" />
            </svg>
    ...
    <section class="flow" id="how-it-works">
        <div class="flow-head">
            ...
            <p>Every case moves through the same three stages — the system tracks each one so nothing sits without a
                record.</p>
        </div>
        <div class="flow-steps">
            <div class="flow-step">
                ...
                <h3>Case referred</h3>
                <p>A case reaches the mediation centre and is logged with its parties, category, and the mediator
                    assigned to it.</p>
            </div>
            <div class="flow-step">
            ...
            <div class="flow-step">
                ...
                <p>The case is marked settled or unsettled, and rolls up automatically into category and phase-wise
                    reports.</p>
            </div>
        </div>
    </section>
    ...
    <div class="modal-overlay" id="loginOverlay">
        <div class="modal" role="dialog" aria-modal="true" aria-labelledby="loginTitle">
            ...
            <form method="POST" action="{{ route('user.login') }}">
                ...
                <div class="field">
                    ...
                    <input id="login" name="login" type="text" value="{{ old('login') }}"
                        placeholder="you@hclsc.gov.in" autocomplete="username">
                    @error('login')
                        <p style="color:#E8542F; font-size:12px; margin-top:6px;">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="modal-foot">
                Access is provisioned by your court administrator.<br>Contact the registry office if you need an
                account.
            </div>
        </div>
    </div>
